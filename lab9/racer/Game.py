...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(f"coin{self.coin}.png")  # Load coin image
        #self.xy = random.randint(20,80)
    ...
    def move(self):
        self.rect.move_ip(0, self.coin * 3)  # Move coin down
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        ...
        COINS += COIN.coin  # Increase coin count
