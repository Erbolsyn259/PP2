...
apples = pygame.image.load('apple.png').convert_alpha()  # Load apple image with transparency
apples = pygame.transform.scale(apples, (50, 50))  # Resize apple image
...
class Apple:
    ...
    def update(self):
        screen.blit(apples, self.rect)  # Draw the apple on the screen
